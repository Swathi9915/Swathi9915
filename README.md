...
Wrote SQL queries to analyze data from Walmart Sales data to understand top performing branches and products, sales trend of different products, customer behaviour.
...
**Description**: 
A data visualization project created in Tableau using Netflix dataset. The dashboard helps users understand patterns in Netflix’s movies and TV shows through interactive charts and filters.
